...
**Opening a DLC Channel**
There is currently no service fee for opening a DLC channel. Please note that this may change in the future.

The _funding transaction_ is the on-chain transaction that occurs when you open your DLC channel. The mining fees or this transaction will be split 50/50 between the user and the 10101 coordinator.

When closing your DLC Channel, there will be no additionnal mining fees to broadcast the commit transaction on-chain: the cost of these fees was anticipated and reserved at the time of the _funding transaction_.
