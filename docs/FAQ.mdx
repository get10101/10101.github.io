...
### Can I use 10101 on several devices using my recovery phrase?

We recommend that you don't try this, as it could lead to a broken state of your trade or DLC Channel.

You must use a unique node ID per device, which means you will have one recovery phrase per device.
...
Our coordinator, will always collateralize your trade with _Quantity_ x2 leverage.
...
Conclusion : your margin in BTC will depend on the opening price, _Quantity_, and on the leverage you choose. Ours will always remain relative to the opening price and _Quantity_ you have selected
...
### What is the _Quantity_

The _Quantity_ is the number of contracts for your trade: the size in USD at the current exchange rate.
_1 contract = 1 USD_
...
In an ideal world there would be no expiry, but it is the only way that we can safely simulate a perpetual swap using DLCs.
DLCs are open until the oracle attests to the outcome of an event (attestation time).
That's why we have a rollover protocol which replaces the old DLC with a new one with an attestation time further in the future.

Positions always expire on Sunday, 15:00 CET, and therefore have a maximum expiration time of one week.

You, as the trader can decide to close your position anytime by clicking _Close position_.
...
We introduced a quick and simple way to renew it, codenamed _rollover weekends_:
If you come online between Friday, 15:00 CET and Sunday, 15:00 CET your position extends for another week.

If you've accidentally rolled over a position you didn't want to keep open, you can decide to close your position at any time by clicking on _Close position_.
...
If you want to resize your position beyond the limits of your DLC Channel, you would have to resize your _channel_.

### Why are my trades limited to small quantity amounts?

If you are short of liquidity on **your side** of the DLC channel, the _Quantity_ you can trade is limited by the liquidity you have on that channel, which reduces the available margin you can commit to a trade.

Same thing the other way around: If you're doing great and the coordinator is short of liquidity on **his side** of the channel, the _Quantity_ you can trade is limited by the liquidity he has on that channel, which reduces the available margin he can commit to a trade.

### Can I resize my _DLC Channel_ (splicing)?

No, but definitely in the future. Splicing would be more cost-effective than closing and reopening a _channel_

At the moment, you will need to close your current _channel_, and open a bigger one.
...
### How can I close my _DLC Channel_?
...
### I can't see my full on-chain balance, how to fix it?

If you are unable to see your full on-chain balance, try refreshing the **wallet screen** by dragging it down.

If nothing changes, go to: _Settings > Wallet Settings_

From there, you can enter a _Stop Gap_ and request a **full wallet synchronization**.

The _Stop Gap_ is the number of consecutive unused addresses the wallet will have to encounter to stop synchronization.

### Can I fund my 10101 wallet using Lightning?

From version 1.8.0, it's no longer possible to fund your wallet nor your _DLC Channel_ via Lightning.
...
https://github.com/get10101/10101/releases

You can find the APK corresponding to the architecture of your device and the associated signature files.
Only the latest release can be used with our coordinator. There might be a new pre-release but this is only in preparation.

### What is the fee structure when I use 10101?

First of all, we need to distinguish between the mining fees corresponding to the required on-chain transactions, and the service fees applied by 10101.

**Opening a _DLC Channel_**
There is currently no service fee for opening a _DLC channel_. Please note that this may change in the future.

The _funding transaction_ is the on-chain transaction that occurs when you open your _DLC channel_. The mining fees or this transaction will be split 50/50 between the user and the 10101 coordinator.

When closing your _DLC Channel_, there will be no additionnal mining fees to broadcast the commit transaction on-chain: the cost of these fees was anticipated and reserved at the time of the _funding transaction_.

_If current mining fees are exceptionally high, your commit transaction may be stuck in the mempool. You can still adjust the fees by bumping the transaction with a CPFP._

**Funding rates**
There is currently no fees for keeping a trade open. Please note that this may change in the future.

**Order matching fees**
The service provided by our coordinator to match your order with a counterparty will be charged 0.3% of the _Quantity_ of your trade (number of contracts, USD) in sats, at the current price exchange.

It is important to note that the closing of a position is an implied opposite trade, and will therefore be charged in the same way as the opening of the position.

Example:

- Alice opens a $1000 **LONG** trade. The coordinator will charge $3, in sats, at the current exchange rate.
- Alice closes her position in profit, which means that she implicitly opens a $1000 **SHORT** trade. The coordinator will charge $3, in sats, at the current exchange rate, i.e. fewer sats than the opening trade, since the price has increased since.
...
Don't hesitate to get in touch with our team, who will be able to help you and answer your questions on our dedicated Telegram [support channel](https://t.me/get10101/1189). If possible, prepare your application logs for us to investigate.
