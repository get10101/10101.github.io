...
Same thing the other way around: If you're doing great and the coordinator is short of liquidity on **his side** of the channel, he _Quantity_ you can trade is limited by the liquidity he has on that channel, which reduces the available margin he can commit to a trade.
